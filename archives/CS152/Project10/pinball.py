...
def main():
    ...
    ball1.setVelocity([random.randint(0,5),20])
    ball1.draw()

    paddle1 = pho.Block(win, 25, 5, 10,2)
    paddle1.draw()

    paddle2 = pho.Block(win, 25, 5, 10,2)
    paddle2.draw()
    ...
    launch(ball1, 40, 10, 0.001, 0.001, 20)
    ...
    pts = gr.Text(gr.Point(250,25), str(points))
    pts.setFace("helvetica")
    pts.setSize(36)
    pts.setStyle("bold")
    pts.setTextColor("yellow")
    pts.draw(win)
